...
public class AlternativeQueryUtils {


    private AlternativeQueryUtils() {
    }
    ...
    public static List<NewsObject> fetchNewsData(String requestUrl, int check) {
...
//        }
        ...
        if (check == 0) {
            ...
            news = extractFeatureFromSecondJson(jsonResponse);
        }
     ...
     */
    public static List<NewsObject> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                String secondUrl = "https://hacker-news.firebaseio.com/v0/item/" + code + ".json?print=pretty";
                news = fetchNewsData(secondUrl, 1);
            }
    ...
    public static List<NewsObject> extractFeatureFromSecondJson(String newsJSON) {
        ...
        try {
            ...
            news.add(new NewsObject(id, time, title, url));
